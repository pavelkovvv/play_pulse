...
class CustomUser(AbstractUser):
    ...
    username = models.CharField(db_index=True, max_length=40, unique=True, null=False, help_text='Ник пользователя')
    ...
    location = models.CharField(max_length=100, blank=True, help_text='Город, в котором находится пользователь')
    is_admin = models.BooleanField(default=False, help_text='Является ли пользователь администратором')
    date_joined = models.DateTimeField(default=timezone.now, help_text='Дата регистрации пользователя')
